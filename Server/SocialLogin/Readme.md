...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SocialLogin*):
...
Execute unit tests
```
    cd "SocialLogin/test/SocialLogin.Tests"
    dotnet test
```

Deploy application
```
    cd "SocialLogin/src/SocialLogin"
